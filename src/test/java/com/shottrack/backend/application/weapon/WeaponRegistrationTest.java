...
class WeaponRegistrationTest {
    ...
    void deveRejeitarCampoObrigatorioAusente() throws Exception {
        var request = new WeaponRegisterRequest(null, glockId, g17Id, caliber9mmId);
    ...
    void deveRejeitarTipoInexistente() throws Exception {
        var request = new WeaponRegisterRequest(UUID.randomUUID(), glockId, g17Id, caliber9mmId);
    ...
    void deveRejeitarMarcaInexistente() throws Exception {
        var request = new WeaponRegisterRequest(pistolaId, UUID.randomUUID(), g17Id, caliber9mmId);
    ...
    void deveRejeitarModeloInexistente() throws Exception {
        var request = new WeaponRegisterRequest(pistolaId, glockId, UUID.randomUUID(), caliber9mmId);
    ...
    void deveRejeitarCalibreInexistente() throws Exception {
        var request = new WeaponRegisterRequest(pistolaId, glockId, g17Id, UUID.randomUUID());
    ...
    void deveRejeitarModeloQueNaoPertenceAMarcaInformada() throws Exception {
        ...
        var request = new WeaponRegisterRequest(pistolaId, glockId, modelo856Id, caliber9mmId);
